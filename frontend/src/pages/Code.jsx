...
const Code = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${baseUrl}/api/auth/forget-password/verify`, { code });
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-sm text-center">
            <Link to="/login/forgot" className="font-medium text-teal-600 hover:text-teal-500">
